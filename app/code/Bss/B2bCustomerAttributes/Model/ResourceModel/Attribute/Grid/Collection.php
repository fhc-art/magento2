 ...
 */
namespace Bss\B2bCustomerAttributes\Model\ResourceModel\Attribute\Grid;
...
class Collection extends SearchResult
{
    ...
    protected function _initSelect()
    {
        ...
        $this->getSelect()->where('eav_attribute.is_user_defined=1')->where('eav_attribute.attribute_code != "b2b_activasion_status"');
    }
