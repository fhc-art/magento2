 ...
 */
namespace Bss\MetaTagManager\Plugin\Model\Category;

/**
 * Class DataProvider
 * @package Bss\MetaTagManager\Plugin\Model\Category
 */
class DataProvider extends \Magento\Catalog\Model\Category\DataProvider
{
        ...
        foreach ($fieldsMap as $fieldSet => $fields) {
            foreach ($fields as $field) {
                if (isset($fieldsMeta[$field])) {
                    if ($field == 'excluded_meta_template') {
                        $fieldsMeta[$field]['sortOrder'] = 640;
                    }
    ...
    public function _getFieldsMap()
    {
        ...
        $fields['search_engine_optimization'][] = 'excluded_meta_template';
        return $fields;
    }
}
