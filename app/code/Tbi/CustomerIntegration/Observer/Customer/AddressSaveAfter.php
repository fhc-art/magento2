...
class AddressSaveAfter implements \Magento\Framework\Event\ObserverInterface
{
    ...
    public function execute(
        ...
        $addressUpdate = $observer->getCustomerAddress();

        $customer_id = $addressUpdate->getCustomerId();
        if ($customer_id) {
            ...
            $postBody = [
                "mode"                  => "U3", // U3 = Update from Address Save After Observer
			   ...
			   // "ADDRESSVAL"            => 	$this->clean($customerAddress->getData('company')), //test removal of & in company name
            ...
            // $logger->info($postBody); //here you will get address data
            // return;
            try {
                ...
                $this->logger->info("AddressSaveAfter");
