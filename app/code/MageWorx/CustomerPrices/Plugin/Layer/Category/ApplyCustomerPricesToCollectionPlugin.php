...
class ApplyCustomerPricesToCollectionPlugin
{
    /**
     * @var HelperData
     */
    ...
    /**
     * ApplyCustomerPricesToCollectionPlugin constructor.
     *
    ...
    public function aroundFilter(
        ...
        if ($customerId) {
            ...
            if ($this->helperCalculate->getLinkField() == HelperCalculate::ROW_ID) {
                $resetColumns['row_id'] = 'e.row_id';
            }

            $select->reset(\Zend_Db_Select::COLUMNS)->columns($resetColumns);
        }
    }
